...
class InventoryDocumentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'source_document_id' => ['nullable', 'exists:central.inventory_documents,id'],
            'workflow_meta' => ['nullable', 'array'],
            'items' => ['required', 'array', 'min:1'],
            'items.*.inventory_item_id' => ['nullable', 'exists:central.inventory_items,id'],
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'source_document_id' => ['sometimes', 'nullable', 'exists:central.inventory_documents,id'],
