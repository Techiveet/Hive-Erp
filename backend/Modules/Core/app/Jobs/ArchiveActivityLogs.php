    ...
    public function handle() {
        ...
        try {
            ...
            DB::connection('central')->transaction(function () use ($cutoffDate) {
                ...
                // 1. Copy old logs to archive table
                DB::connection('central')->statement("
                    ...
                    SELECT log_name, description, subject_type, subject_id, causer_type, causer_id, properties, batch_uuid, event, tenant_id, created_at, updated_at
                    FROM activity_log
