...
use App\Models\User;
use App\Models\Language; // 🚀 Added Language Model
...
class ActivityLogExportController extends Controller
{
    ...
    public function handleExport(Request $request)
    {
        ...
        try {
            ...
            // 🚀 THE FIX: Safely fetch the dictionary. If cache is empty, pull directly from DB!
            ...
            if ($type === 'pdf') {
                ...
                $pdf = Pdf::loadView('exports.activity-log-export', [
