...
export const projectApi = {
  ...
  getGlobalWorkload: () => api.get<any[]>(`${PM_PREFIX}/members/global-workload`).then(res => res.data),
  ...
  getMyTasks: (params?: { status?: 'active' | 'completed', priority?: string, per_page?: number }) => 
    api.get<{ data: Task[], meta: any }>(`${PM_PREFIX}/my-tasks`, { params }).then(res => res.data),
  ...
  addComment: (taskId: string, data: { content: string, parent_id?: number | null, attachments?: any[] | null }) => 
    api.post(`${PM_PREFIX}/tasks/${taskId}/comments`, data).then(res => res.data),
  updateTaskComment: (commentId: number, data: { content: string, attachments?: any[] | null }) =>
  ...
  getProjectComments: (projectId: string, params?: { page?: number; per_page?: number }) =>
    api.get<any>(`${PM_PREFIX}/projects/${projectId}/comments`, { params })
      .then(res => res.data),
  addProjectComment: (projectId: string, data: { content: string, parent_id?: number | null, attachments?: any[] | null }) => 
    api.post(`${PM_PREFIX}/projects/${projectId}/comments`, data).then(res => res.data),
  updateProjectComment: (commentId: number, data: { content: string, attachments?: any[] | null }) =>
  ...
  // Automations
  getAutomations: (projectId: string) => api.get<any[]>(`${PM_PREFIX}/projects/${projectId}/automations`).then(res => res.data),
  createAutomation: (projectId: string, data: any) => api.post(`${PM_PREFIX}/projects/${projectId}/automations`, data).then(res => res.data),
  updateAutomation: (id: number, data: any) => api.put(`${PM_PREFIX}/automations/${id}`, data).then(res => res.data),
  deleteAutomation: (id: number) => api.delete(`${PM_PREFIX}/automations/${id}`),

  // Project Goals
  getProjectGoals: (projectId: string) => 
    api.get<any[]>(`${PM_PREFIX}/projects/${projectId}/goals`).then(res => res.data),
  addProjectGoal: (projectId: string, data: { title: string }) => 
    api.post<any>(`${PM_PREFIX}/projects/${projectId}/goals`, data).then(res => res.data),
  updateProjectGoal: (goalId: number, data: { title?: string, is_completed?: boolean, order?: number }) => 
    api.put<any>(`${PM_PREFIX}/goals/${goalId}`, data).then(res => res.data),
  ...
  // Sprints
  createSprint: (projectId: string, data: { name: string, start_date?: string, end_date?: string, goal?: string }) => 
    api.post<any>(`${PM_PREFIX}/projects/${projectId}/sprints`, data).then(res => res.data),
  updateSprint: (sprintId: string, data: any) => 
    api.put<any>(`${PM_PREFIX}/sprints/${sprintId}`, data).then(res => res.data),
  ...
  getFinancialReport: (projectId: string) => 
    api.get<any>(`${PM_PREFIX}/projects/${projectId}/financial-report`).then(res => res.data),
};
