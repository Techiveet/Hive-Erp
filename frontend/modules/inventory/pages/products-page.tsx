...
import { Box, ClipboardCheck, Copy, DollarSign, ExternalLink, Eye, FileText, Info, Layers, Loader2, MapPin, Maximize2, Package, Pencil, Plus, QrCode, Settings2, ShieldCheck, Trash2, TrendingUp, Truck, XIcon, UserCheck } from "lucide-react";
...
export default function InventoryProductsPage() {
  ...
  const columns = React.useMemo<ColumnDef<ProductRecord>[]>(
    ...
    [deleteMutation, openDetailSheet, openEdit, openQaDialog, t]
  );
    ...
    <div className="space-y-6">
      ...
      {detailProductId && (
        <ProductDetailSheet 
          ...
          onRequestApproval={(product: ProductRecord) => {
            closeDetailSheet();
          }}
        />
      )}
...
function ProductDetailSheet({
  ...
  onRequestApproval: (product: ProductRecord) => void;
}) {
  const queryClient = useQueryClient();
